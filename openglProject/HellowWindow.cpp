...
int main()
{
    ...
    Shader ssaaShader("..\\shader\\copyVertex.txt", "..\\shader\\ssaaFragment.txt");
...
#elif defined SSAA
    //渲染缩放
    float width = SCR_WIDTH * SCALE;
    float height = SCR_HEIGHT * SCALE;
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        ssaaShader.use();
        glBindTexture(GL_TEXTURE_2D, texture);
        ssaaShader.setFloat("exposure", 5.0);
        RenderQuad();
#endif
